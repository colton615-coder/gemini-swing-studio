...
const generateHoles = (numHoles: number, coursePar: number, region: 'nyc' | 'longisland' | 'westchester' | 'upstate' | 'central' | 'western') => {
  ...
  const parDistribution = numHoles === 18 
    ? [4,4,3,4,5,3,4,4,4,4,4,3,5,4,4,3,4,5]
    : numHoles === 9
    ? [4,3,4,5,4,3,4,4,4]
    : Array(numHoles).fill(4);
...
export const comprehensiveNYCourses: Course[] = [
  // NYC Public Courses
  {
  ...
  {
    name: "North Hempstead Golf Course",
    location: "Port Washington, NY",
    holes: generateHoles(18, 71, 'longisland')
  },
  {
  ...
  },
  {
    ...
    holes: generateHoles(18, 71, 'central')
  },
  {
